...
GPT_PRETRAINED_CONFIG_ARCHIVE_MAP = {
...
class GPTConfig(PretrainedConfig):
    ...
    Args:
        ...
        summary_type (`string`, *optional*, defaults to `"cls_index"`):
            Argument used when doing sequence summary, used in the models [`GPTDoubleHeadsModel`] and
            [`TFGPTDoubleHeadsModel`].
    ...
    ```python
    >>> from transformers import GPTConfig, GPTModel
